...
import { Activity, Database, Users, TrendingUp, ExternalLink, AlertCircle, RefreshCw } from "lucide-react";
import { cn } from "@vamsa/ui";

export const Route = createFileRoute("/_authenticated/admin/metrics")({
  loader: async () => {
    const [currentUser, prometheusStatus] = await Promise.all([
      getCurrentUser(),
      getPrometheusStatus(),
    ]);
    return { currentUser, prometheusStatus };
  },
...
function MetricsPage() {
  const { currentUser, prometheusStatus } = Route.useLoaderData();
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Cannot connect to Prometheus at {prometheusStatus.url}.
